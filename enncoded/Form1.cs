...
namespace enncoded
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBox1.Text = "C:\\Mouhamad\\Projects\\enncoded\\bin\\Debug\\00014.txt";
			// 
			// textBox2
			// 
			...
			this.textBox2.Text = "C:\\Mouhamad\\Projects\\enncoded\\bin\\Debug\\00014.jpg";
			// 
			// label2
			// 
			...
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(352, 24);
		...
		{
			enncoded.ProcessDecodeFile s  = new enncoded.ProcessDecodeFile(this.textBox1.Text);
			s.DoDecoding();
		...
		{
			enncoded.ProcessEncodeFile a = new enncoded.ProcessEncodeFile(this.textBox2.Text,this.textBox1.Text);
			a.doEncoding();
		}
		...
		{
			OpenFileDialog fd = new OpenFileDialog();
			fd.Filter ="*.zip|*.EXE|*.jpg|*.Gif|*.wav|*.mp3|*.*|";
			if (fd.ShowDialog() == DialogResult.OK) 
			{
