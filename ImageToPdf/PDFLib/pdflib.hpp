...
// $Id: pdflib.hpp,v 1.46 2004/06/13 12:20:44 tm Exp $
//
...
public:
    ...
    int add_bookmark(string text, int parent, int p_open) throw(PDFlib::Exception);
    ...
    void add_note(double llx, double lly, double urx, double ury, string contents,
	...
	double c, double d, double e, double f, string optlist) throw(PDFlib::Exception);
    ...
    void create_fieldgroup(string name, string optlist) throw(PDFlib::Exception);
    int create_gstate (string optlist) throw(PDFlib::Exception);
    void create_pvf(string filename, void *data, size_t size, string optlist)
	throw(PDFlib::Exception);
    ...
    int findfont(string fontname, string encoding, int embed) throw(PDFlib::Exception);
	...
	throw(PDFlib::Exception);
    string get_pdi_parameter(string key, int doc, int page, int reserved, int *len = NULL) throw(PDFlib::Exception);
    ...
    int open_pdi(string filename, string optlist, int reserved) throw(PDFlib::Exception);
    int open_pdi_page(int doc, int pagenumber, string optlist) throw(PDFlib::Exception);
    ...
    void rect(double x, double y, double width, double height) throw(PDFlib::Exception);
    ...
    void set_border_color(double red, double green, double blue) throw(PDFlib::Exception);
    ...
    void set_layer_dependency(string type, string optlist) throw(PDFlib::Exception);
    ...
    double stringwidth(string text, int font, double fontsize) throw(PDFlib::Exception);
    ...
    string utf8_to_utf16(string utf8string, string format) throw(PDFlib::Exception);
    void xshow(string text, const double *xadvancelist) throw(PDFlib::Exception);
